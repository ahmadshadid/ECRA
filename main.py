...
fig5.add_trace(
    ...
    col=1, secondary_y=False)
fig5.add_trace(go.Scatter(x=df_initial_tps.index, y=df_initial_tps[selected_crypto_fi].rolling(20).mean(),
...
fig5.add_trace(go.Scatter(x=df_initial_ats.index, y=rawfinal['close'], name='close and ats_index' + ' ' + str(selected_crypto), line=dict(width=2,
               ...
               col=1, secondary_y=True,)
fig5.add_trace(
    go.Scatter(x=df_initial_tps.index, y=df_initial_tps_global["tps_global"].rolling(20).mean(), name="MAVG_tps_weighted_global ",
