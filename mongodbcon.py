...
# get_dev database
market_data_dev = pymongo.MongoClient(
    "mongodb+srv://ramziadmin:ramziadmin@cluster2.e6ban.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
